...
(function() {
  var DelayedOp, DelayedSyncAnimation, Dropbox, DropboxClient, DropboxOauth, DropboxXhr, DropboxXhrCanSendForms, DropboxXhrIeMode, DropboxXhrRequest, OneOp, Set, add32, arrayToBase64, atob, atobNibble, base64Digits, base64HmacSha1, base64Sha1, btoa, btoaNibble, crypto, dropboxEncodeKey, exports, headID, hmacSha1, newScript, rotateLeft32, sha1, stringToArray, _base64Digits,
  ...
  */
  ...
  (function() {
    var $, Auth, Binary, Class, Client, Events, Model, Nimbus, Share, isArray, makeArray, moduleKeywords;
    ...
    Auth.extend({
      ...
      setup: function(sync_service, key, secret, app_name) {
  ...
  Nimbus.Client.Dropbox = {
    ...
    authorize_token: function(request_token) {
      ...
      if (document.URL.slice(0, 4) === "file" && (typeof cordova !== "undefined" && cordova !== null)) {
        ...
        return_url = "&oauth_callback=" + encodeURI(document.URL);
  ...
  Nimbus.backbone_sync = function(method, model, options) {
    ...
    switch (method) {
      case "read":
        resp = (model.id ? store.find(model) : store.all());
        break;
      case "create":
